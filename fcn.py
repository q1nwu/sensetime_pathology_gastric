...
class FCN32s(nn.Module):
    ...
    def forward(self, x):
        ...
        cls_score = self.fc(self.pool(x5).view(-1, 512))
        ...
        return score, cls_score  # size=(N, n_class, x.H/1, x.W/1)
...
def vgg19fcn32(classes=1, pretrained_base=None, **kwargs):

    vgg_model = VGGNet(model='vgg19')

    fcn_model = FCN32s(pretrained_net=vgg_model, n_class=classes)
